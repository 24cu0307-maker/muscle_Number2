...
public class UIController : MonoBehaviour
{
    ...
    private List<GameObject> m_currentFrame = new List<GameObject>();
    ...
    public List<GameObject> GetCurrentFrame()
    {
    ...
    */
    ...
    public void UISet_normal(CSVDataPoseFlow pose)
    {
        ...
        //isPoseShown = true;
        m_currentFrame.Add(m_Frame[pose.PoseID].m_currentFrameApproaching);
        m_currentFrame.Add(m_Frame[pose.PoseID].m_currentFrameWating);
    }
    ...
    public void UIJudgeEnd_normal(CSVDataPoseFlow pose)
    {
        ...
        m_currentFrame.Add(m_Frame[pose.PoseID].m_currentFrameSuccess);
